...
%                         set(points_to_delete,'CData',[0 0 0])
%                     end
...
%                         p   = flipud(findobj(S.sp(ch),'type','scatter'))
%                         p1 = p(1,:);
%                         points_to_delete = [points_to_delete scatter(S.sp(k),p1.XData(bt4ch),p1.YData(bt4ch),'ko','filled')];
%                         set(points_to_delete,'CData',dotcolor)
%                     end
