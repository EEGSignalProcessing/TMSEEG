classdef tmseeg_v31App < handle
    ...
    properties (Constant)
        AppPathBase = {'/tmseeg_v31/code'};
        AppClass = 'tmseeg_v31App';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            tmseeg_v31App.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'tmseeg_main')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong tmseeg_main
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'tmseeg_main').getString, ...
