classdef tmseeg_v30_macApp < handle
%
% Usage:
%     app.tmseeg_v30_macApp

  properties
      AppPath = {'/tmseeg_v30_mac'};
	  AppClass = 'tmseeg_v30_macApp';
	  AppHandle;
	  AppCount = 0;
      Increment = 1;
	  Decrement = 0;
  ...
  methods
    ...
    function obj = tmseeg_v30_macApp()      
    ...
    function startApp(obj)
        ...
        tmseeg_v30_macApp.refcount(obj.Increment);
