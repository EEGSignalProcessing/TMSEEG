...
function com = tmseeg_pop_prop_modified(EEG, typecomp, chanorcomp, winhandle, spec_opt,disp_pack)
global backcolor
com = '';
if nargin < 1
	help pop_prop;
...
if isequal(get(obj,'String'),'Remove')
    ...
    set(findobj('tag',num2str(find(I==chanorcomp)),'style','radio'),'value',1)
    set(findobj('tag',num2str(find(I==chanorcomp)),'style','push'),'string',label{get(obj,'value')})
end
